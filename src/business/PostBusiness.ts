    ...
    public editPost = async (input: EditPostInputDTO): Promise<void> => {
        ...
        if(token === undefined) {
         ...
         if(postDB.creator_id !== creatorId){
            throw new BadRequestError("Só o dono do post pode edita-lo")
         }
     ...
     public deletePost = async (input: DeletePostInputDTO): Promise<void> => {
        ...
        if(token === undefined) {
         ...
         if(
            ...
            throw new BadRequestError("Só um adm ou o dono do post pode deletar")
         }
     ...
     public likeOrDislikePost = async (input: LikeOrDislikePostInputDTO): Promise<void> => {
        ...
        if(token === undefined) {
         ...
         .findPostsWithCreatorById(idToLikeOrDislike)
